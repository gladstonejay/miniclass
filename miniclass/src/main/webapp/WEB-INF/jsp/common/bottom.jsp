...
<nav class="bar bar-tab">
    <a class="tab-item active" href="/classLearn/showUserClass.j" external>
        <span class="icon" ><img src="../../../static/imags/tab/tab1-active.png" width="36" ></span>
        <span class="tab-label">课程学习</span>
    </a>
    <a class="tab-item" href="/review/showTips.j" external>
        <span class="icon"><img src="../../../static/imags/tab/tab3.png" width="30" ></span>
    ...
    <a class="tab-item" href="/my/my.j" external>
        <span class="icon"><img src="../../../static/imags/tab/tab4.png" width="30" ></span>
