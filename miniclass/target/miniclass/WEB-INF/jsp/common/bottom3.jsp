...
<nav class="bar bar-tab">
    <a class="tab-item" href="/classLearn/showUserClass.j" external>
        <span class="icon" ><img src="../../../static/imags/tab1.png" width="36" ></span>
    ...
    <a class="tab-item active" href="/review/showTips.j" external>
        <span class="icon"><img src="../../../static/imags/tab3-active.png" width="30" ></span>
